    ...
    <>
      ...
      <main className="pt-20 pb-5 min-h-screen bg-white text-gray-800 font-sans px-4 sm:px-6 md:px-10 dark:bg-[#1F1B16] dark:text-[#FAF4ED] transition-colors duration-300">
        <div className="max-w-5xl mx-auto mt-16 sm:mt-20 flex flex-col lg:flex-row items-start gap-8">
          ...
          <div className="bg-[#FEF7EC] dark:bg-[#2C2113] border border-[#F9C06B] dark:border-yellow-700 text-gray-800 dark:text-white rounded-xl shadow-md p-6 w-full lg:w-1/3 mt-6 sm:mt-8">
            <div className="flex-shrink-0 text-center space-y-6">
              ...
              />
              <div className="flex flex-col items-center gap-2 text-gray-600 dark:text-[#FFD39F] text-sm">
                <a href="https://www.linkedin.com/in/ratherbearpan" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-blue-600 dark:hover:text-orange-300">
                  <FaLinkedin /> LinkedIn
                </a>
                <a href="https://github.com/Arpan-bug" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-gray-800 dark:hover:text-orange-300">
                  <FaGithub /> GitHub
                </a>
                <a href="https://instagram.com/ratherbearpan" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-pink-500 dark:hover:text-pink-300">
                  <FaInstagram /> Instagram
                </a>
                <a href="mailto:arpansaha121@gmail.com" className="flex items-center gap-2 hover:text-green-600 dark:hover:text-green-400">
                  <FaEnvelope /> arpansaha121@gmail.com
                </a>
              </div>
            </div>
          </div>
...
<div className="bg-[#FEF7EC] dark:bg-[#2C2113] border border-[#F9C06B] dark:border-yellow-700 text-gray-800 dark:text-white rounded-xl shadow-md p-6">
        ...
        <div className="flex justify-between items-baseline gap-2">
          <div className="w-4/5 sm:w-auto">
            ...
            <div className="italic">
              Ivy College of Business<span className="not-italic text-gray-700 dark:text-gray-400">, IA, USA</span>
            </div>
          </div>
          <span className="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap">Jan 2025 – Present</span>
        </div>
      ...
      <li>
        <div className="flex justify-between items-baseline gap-2">
          <div className="w-4/5 sm:w-auto">
            ...
            <div className="italic">
              Institute of Technical Education and Research<span className="not-italic text-gray-700 dark:text-gray-400">, BBSR, INDIA</span>
            </div>
          </div>
          <span className="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap">Jun 2023</span>
        </div>
        <div className="text-sm text-gray-700 dark:text-gray-200">
          Bachelor of Technology in Computer Science Engineering
        </div>
        <div className="text-sm text-gray-600 dark:text-gray-400">GPA: 7.92 / 10.00</div>
      </li>
...
<section className="mb-6">
  ...
  <div className="grid gap-6 md:grid-cols-2">
    ...
    <div className="bg-[#FEF7EC] dark:bg-[#2C2113] border border-[#F9C06B] dark:border-yellow-700 rounded-xl shadow-md p-5 text-gray-800 dark:text-white">
      <h3 className="font-semibold text-lg mb-1">📊 AI-Driven 10-K Analysis – Goldman Sachs vs. Morgan Stanley</h3>
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-1"><em>2025</em></p>
    ...
    <div className="bg-[#FEF7EC] dark:bg-[#2C2113] border border-[#F9C06B] dark:border-yellow-700 rounded-xl shadow-md p-5 text-gray-800 dark:text-white">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-1"><em>2023</em></p>
      <p className="text-sm text-gray-800 dark:text-gray-200">
...
<section className="mb-8">
  <div className="bg-[#FEF7EC] dark:bg-[#2C2113] border border-[#F9C06B] dark:border-yellow-700 rounded-xl shadow-md p-6 text-gray-800 dark:text-white">
      ...
      <li>
        <div className="flex justify-between items-baseline gap-2">
          <div className="w-4/5 sm:w-auto">
            ...
            <div className="text-gray-700 dark:text-gray-400">Kolkata, India</div>
          </div>
          <span className="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap">May 2023 – Sept 2023</span>
        </div>
        <div className="text-sm text-gray-800 dark:text-gray-200 font-medium mb-1">Programmer Analyst Intern</div>
    ...
    <ul className="list-none space-y-6">
      ...
      <li>
        <div className="flex justify-between items-baseline gap-2">
          ...
          <span className="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap">Oct 2023 – Dec 2024</span>
        </div>
        <div className="text-sm text-gray-800 dark:text-gray-200 font-medium mb-1">Logistics Coordinator</div>
        <ul className="list-disc list-inside text-sm text-gray-700 dark:text-gray-300 space-y-1 pl-4">
          <li>
      ...
      <li>
        <div className="flex justify-between items-baseline gap-2">
          ...
          <span className="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap">Jan 2024 – Dec 2024</span>
        </div>

        <div className="text-sm text-gray-800 dark:text-gray-200 font-medium mb-1">Co-Founder, Project Management</div>
        <ul className="list-disc list-inside text-sm text-gray-700 dark:text-gray-300 space-y-1 pl-4">
          <li>
...
<section className="mb-12">
  ...
  <div className="grid gap-6 md:grid-cols-2">
    {/* Repeating Card Template */}
    <div className="bg-[#FEF7EC] dark:bg-[#2C2113] border border-[#F9C06B] dark:border-yellow-700 rounded-xl shadow-md p-5 text-gray-800 dark:text-white">
      <h3 className="font-semibold text-lg mb-1">🐻 ISU Dining, Hawthorn Community Center</h3>
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Ames, IA — <em>Jan 2025 – Present</em></p>
      <p className="text-sm text-gray-800 dark:text-gray-200">
    ...
    <div className="bg-[#FEF7EC] dark:bg-[#2C2113] border border-[#F9C06B] dark:border-yellow-700 rounded-xl shadow-md p-5 text-gray-800 dark:text-white">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-1"><em>Sept 2023 – Present</em></p>
      <p className="text-sm text-gray-800 dark:text-gray-200">
    ...
    <div className="bg-[#FEF7EC] dark:bg-[#2C2113] border border-[#F9C06B] dark:border-yellow-700 rounded-xl shadow-md p-5 text-gray-800 dark:text-white">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-1"><em>Until Dec 2025</em></p>
      <p className="text-sm text-gray-800 dark:text-gray-200">
    ...
    <div className="bg-[#FEF7EC] dark:bg-[#2C2113] border border-[#F9C06B] dark:border-yellow-700 rounded-xl shadow-md p-5 text-gray-800 dark:text-white">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-1"><em>Dec 2025</em></p>
      <p className="text-sm text-gray-800 dark:text-gray-200">
    ...
    <div className="bg-[#FEF7EC] dark:bg-[#2C2113] border border-[#F9C06B] dark:border-yellow-700 rounded-xl shadow-md p-5 text-gray-800 dark:text-white">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400 mb-1"><em>Ongoing</em></p>
      <p className="text-sm text-gray-800 dark:text-gray-200">
